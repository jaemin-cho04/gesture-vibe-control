...
# Calibration thresholds — tune these to your hand size
IDX_MIN = 300  # Index finger: curled position
IDX_MAX = 400  # Index finger: fully extended

PNK_MIN = 150  # Pinky finger: curled position
PNK_MAX = 250  # Pinky finger: fully extended

index_locked = False
pinky_locked = False

print("Area Counter Active!")
...
while cap.isOpened():
    ...
    if all(id in lm_dict for id in [0, 8, 20]):
        ...
        # Index finger fully extended -> increment
        ...
        # Pinky fully extended -> decrement
